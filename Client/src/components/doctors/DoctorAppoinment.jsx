...
const DoctorAppoinment = () => {
    ...
    const deleteSlot =()=>{
        fetch(`http://localhost:8000/doctor/delete-slot/${currentSelectedEvent._id}`,{
            method: "DELETE",
            headers: {
                "Content-Type": "application/json",
                "Authorization": user?.token,
        ...
        <div className="modal-content">
            ...
            <div className="modal-body">
                ...
                <div className='d-flex justify-content-between'>
                    <p>
                        <b>Start Date:</b> {clickSlot?.start.toDateString()} 
                    </p>
                    <p>
                        <b>Start Time: </b>{clickSlot?.start.toLocaleTimeString()}
                    </p>
                </div>

                <div className='d-flex justify-content-between'>
                    <p>
                        <b>End Date:</b> {clickSlot?.end.toDateString()} 
                    </p>
                    <p>
                        <b>End Time: </b>{clickSlot?.end.toLocaleTimeString()}
                    </p>
            </div>
    ...
    >
        ...
        <div className="modal-content">
            ...
            <div className="modal-body">
                ...
                <div className='d-flex justify-content-between'>
                    <p>
                        <b>Start Date:</b> {currentSelectedEvent?.start.toDateString()} 
                    </p>
                    <p>
                        <b>Start Time: </b>{currentSelectedEvent?.start.toLocaleTimeString()}
                    </p>
                </div>
                ...
                <div className='d-flex justify-content-between'>
                    ...
                    <p>
                        <b>End Time: </b>{currentSelectedEvent?.end.toLocaleTimeString()}
                    </p>
            </div>
            <div className="d-flex">
                                    ...
                                    <h5>{currentSelectedEvent?.bookedBy?.name}</h5>
                                ...
                                <div className="d-flex">
                                    <FontAwesomeIcon
                                        ...
                                        icon={faEnvelope}
                                    />
                                    <p>{currentSelectedEvent?.bookedBy?.email}</p>
                                </div>
